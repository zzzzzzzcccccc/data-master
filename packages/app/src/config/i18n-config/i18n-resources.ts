const resources = {
  'en-US': {
    translation: {
      ...
      unique: 'Unique',
      foreigner: 'Foreigner',
      foreigner_table_column: 'Foreigner: {{ table }}.{{ column }}',
      checks: 'Checks',
      sql_query_title: 'SQL Query',
      sql_query_result: 'Executed successfully, insertId: {{ insertId }}, affectedRows: {{ affectedRows }}',
      sql_query_total: 'Total: {{ total }}',
      sql_query_duration: 'Duration: {{ duration }} ms',
    },
    displayLang: '🇺🇸 English',
  },
  'zh-CN': {
    translation: {
      ...
      unique: '唯一',
      foreigner: '外键',
      foreigner_table_column: '外键: {{ table }}.{{ column }}',
      checks: '检查约束',
      sql_query_title: 'SQL查询',
      sql_query_result: '执行完成插入Id: {{ insertId }}, 影响行数: {{ affectedRows }}',
      sql_query_total: '总计: {{ total }}',
      sql_query_duration: '耗时: {{ duration }} ms',
    },
    displayLang: '🇨🇳 简体中文',
  },
}
